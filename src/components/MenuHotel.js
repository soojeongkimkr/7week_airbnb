  ...
  return(
    ...
    <div className="item__contents">
      ...
      <div className="contents__menu">
        ...
        {/* <div className="startSearchTxt">검색 시작하기</div> */}
      </div>
...
const MenuHotelWrap = styled.div`
  ${({ theme }) => {
    ...
    return css`
      ...
      /* 여행자 검색 */
      .item__contents .contents__menu .contents:nth-of-type(4) {
          padding-left: 25px;
          padding-right:100px;
          border-radius: 200px;
      }
      ...
      .item__contents .contents__menu .contents:nth-of-type(4)::before {
          display:none;
      }
